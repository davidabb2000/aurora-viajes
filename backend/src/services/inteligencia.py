...
from src.models.viajes import Paquete, Reserva
...
async def obtener_recomendaciones(
    ...
    # 1. Obtener catálogo disponible (paquetes con cupos)
    ...
    # 2. Consultar a Groq (o usar fallback si falla)
    try:
...
async def evaluar_riesgo(
    ...
    # Las predicciones de ML bloquean el CPU, las enviamos a un threadpool
